...
function App() {
  ...
  return (
   ...
   <RecentSearch recentHistory={recentHistory} setRecentHistory={setRecentHistory} setSelectedHistory={setSelectedHistory} />
      <div className='col-span-4 px-4 py-5 flex flex-col items-center justify-between '>
       <h1 className="text-4xl bg-clip-text text-transparent bg-gradient-to-r from-pink-700 to-violet-700"> Hi, I’m <span className="font-bold">VINChat</span> — ask me anything </h1>
        {
          loader ?
            <div role="status">
        ...
        <div ref={scrollToAns} className='container h-120 overflow-y-scroll px-2'>
        ...
        <div className='dark:bg-zinc-800 bg-red-100 w-1/2 p-1 pr-5 dark:text-white text-zinc-800 rounded-4xl
